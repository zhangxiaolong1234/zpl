<template>
    <div class="benefit">
      ...
      <div class="zplson1">
        ...
        <span class="zpl1">我的优惠</span>
      </div>
      <div class="zpl2">
        <div class="zpl3" @click="changeHong">
          <router-link :to="{}">红包</router-link>
        </div>
        <div class="zpl4" @click="quan"><router-link :to="{}">商家代金券</router-link></div>
      </div>
      ...
      <div class="zpl5" v-if="shopticket">
        ...
        <div class="zpl16">
          <div class="zpl17">
            <router-link :to="{}">兑换红包</router-link>
          </div>
          <div class="zpl18">
            <router-link :to="{}">推荐有奖</router-link>
          </div>
        </div>
      </div>
      ...
      <div class="zpl19" v-if="changequan">
        <router-link :to="{}" class="el-icon-question zpl20">商家代金券说明</router-link>
