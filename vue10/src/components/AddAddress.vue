    ...
    <div class="addAddress">
      ...
      <section class="page_text_container">
        ...
        <section class="section_list">
          ...
          <section class="section_right">
            <router-link to='/confirmOrder/chooseAddress/addAddress/searchAddress' class="chooseAddress">{{searchAddress? searchAddress.name : '小区/写字楼/学校等'}}</router-link>
...
<script>
    ...
    export default {
        ...
        mounted() {
          ...
          this.searchAddress = this.$store.state.place;
          // console.log(this.searchAddress.name)
